...
def font_page():
    ...
    faq = [
        ...
        ("Фонтыг яаж татаж суулгах вэ?", "Фонт дээр дараад «Google Fonts-оос татах» товчоор орж «Get font → Download» дарна. Татсан .ttf файлыг давхар дарж «Install» хийнэ. Вэб дээр бол «CSS хуулах» товчоор гарах кодыг сайтдаа хуулна."),
  ...
  <section class="lp-hero app-hero">
    <p class="lp-kicker">ҮНЭГҮЙ · {n} ФОНТ · Ө Ү ШАЛГАСАН</p>
    <h1>Монгол фонт хайгч</h1>
    <p class="lp-lead">Google Fonts-ын 1900 гаруй фонтоос монгол <b>Ө, Ү</b> үсгийг бүрэн дэмждэг {n}-ыг нэг бүрчлэн шалгаж цуглуулав. Өөрийн текстээ бичээд бүх фонтоор шууд хараарай.</p>
  </section>
...
"""
    return dict(slug="mongol-font", icon="font",
                title=f"Монгол фонт — Ө, Ү дэмждэг {n} кирилл фонт, шууд харах | Graphican",
                desc=f"Монгол хэлний Ө, Ү үсгийг бүрэн дэмждэг {n} үнэгүй кирилл фонт. Өөрийн текстээр шууд харж, харьцуулж, CSS хуулж, Google Fonts-оос татна. Лого, постер, вэбсайтад.",
...
def color_page():
    ...
    body = f"""
  <section class="lp-hero app-hero">
    <p class="lp-kicker">ҮНЭГҮЙ · 12 САЛБАР · МОНГОЛ УЛАМЖЛАЛТ ӨНГӨ</p>
    <h1>Брэндийн өнгө үүсгэгч</h1>
    <p class="lp-lead">Салбараа сонгоход брэндэд тохирох 5 өнгийн палитр гарна. Лого, сошиал пост, вэбсайт, нэрийн хуудас дээр шууд харж, уншигдах эсэхийг шалгаад, HEX, CSS, PNG-ээр авна.</p>
  </section>
...
def templates_page():
    ...
    faq = [
        ...
        ("Монгол үсэг зөв гарах уу?", "Тийм. Бүх загварт монгол Ө, Ү үсгийг бүрэн дэмждэг фонтуудыг (Montserrat, Inter, Lora, Oswald, Cormorant Garamond, Rubik) ашигласан."),
  ...
  <section class="lp-hero app-hero">
    ...
    <p class="lp-lead">Цагаан сар, Наадам, шинэ жилийн мэндчилгээ, ажлын зар, хямдрал, хоолны цэс, сургалтын бүртгэл зэрэг бэлэн загварыг сонгоод онлайн засварлагч дээр өөрийн мэдээллээр солиод татаарай.</p>
  </section>
...
"""
    return dict(slug="templates", icon="layout",
                ...
                scripts=["/assets/vendor/fabric.min.js", f"/assets/templates.js?v={V}", f"/assets/tplgallery.js?v={V}"])
