...
def templates_page():
  ...
  <section class="lp-hero app-hero">
    ...
    <p class="lp-lead">Цагаан сар, Наадам, шинэ жилийн мэндчилгээ, ажлын зар, хямдрал, хоолны цэс, сургалтын бүртгэл, концерт, YouTube thumbnail зэрэг 34 трэнд загварыг сонгоод онлайн засварлагч дээр өөрийн мэдээллээр солиод татаарай.</p>
  </section>
